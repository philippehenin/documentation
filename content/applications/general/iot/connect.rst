...
.. note::
   ...
   code is no longer visible, :ref:`reboot the IoT box <iot/iot-box/reboot>` or :ref:`restart the
...
- The :ref:`pairing code` display time has expired. :ref:`Reboot the IoT box <iot/iot-box/reboot>`
...
- :ref:`Reboot the IoT box <iot/iot-box/reboot>` or :ref:`restart the Windows virtual IoT service
